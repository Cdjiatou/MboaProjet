...
exports.generateWithdrawalsCSV = exports.generateVotesCSV = void 0;
// --- Imports des dépendances ---
// Client Prisma pour les requêtes en base de données
const prisma_1 = __importDefault(require("../utils/prisma"));
// Fonction utilitaire de masking des identifiants
const maskIdentifier_1 = require("../utils/maskIdentifier");
// =============================================================================
// CONSTANTES
// =============================================================================
/**
...
const generateVotesCSV = async () => {
    ...
    const rows = votes.map(vote => {
        ...
        const maskedIdentifier = (0, maskIdentifier_1.maskVoterIdentifier)(vote.voterIdentifier);
...
exports.generateVotesCSV = generateVotesCSV;
// =============================================================================
 ...
 * @returns Le contenu CSV complet sous forme de chaîne de caractères (avec BOM UTF-8).
 */
const generateWithdrawalsCSV = async () => {
...
exports.generateWithdrawalsCSV = generateWithdrawalsCSV;
