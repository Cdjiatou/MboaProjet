...
exports.updateProfile = exports.resendOtp = exports.verifyOtp = void 0;
...
exports.verifyOtp = (0, catchAsync_1.catchAsync)(async (req, res) => {
    ...
    const result = await (0, candidate_service_1.verifyCandidateOtp)(phone, otp);
    res.json({ success: true, message: 'OTP vérifié avec succès.', data: result });
});
exports.resendOtp = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const { phone } = req.body;
    const result = await (0, candidate_service_1.resendCandidateOtp)(phone);
...
exports.updateProfile = (0, catchAsync_1.catchAsync)(async (req, res) => {
    ...
    const updatedCandidate = await (0, candidate_service_1.completeProfile)(candidateId, req.body);
