...
exports.getVoteStatus = exports.maviansWebhook = exports.initiateCandidateVote = exports.getCandidateBySlug = exports.getCategories = exports.getConfig = void 0;
...
exports.getConfig = (0, catchAsync_1.catchAsync)(async (req, res) => {
    ...
    const configs = await prisma_1.default.siteConfiguration.findMany();
    ...
    const resolvedSponsors = (0, sponsorsConfig_1.resolvePublicSponsors)((0, sponsorsConfig_1.parseSponsorsConfig)(configMap.sponsors));
 ...
 */
exports.getCandidateBySlug = (0, catchAsync_1.catchAsync)(async (req, res) => {
    ...
    if (!candidate || candidate.status !== 'ACTIVE') {
        throw new AppError_1.AppError('Candidat introuvable ou inactif.', 404);
    }
 ...
 */
exports.initiateCandidateVote = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const { candidateId, voterIdentifier, amount, paymentMethod } = req.body;
    const result = await (0, vote_service_1.initiateVote)(Number(candidateId), voterIdentifier, Number(amount), paymentMethod);
    res.status(201).json({
        success: true,
 ...
 */
exports.maviansWebhook = (0, catchAsync_1.catchAsync)(async (req, res) => {
    ...
    if (!paymentReference || !status) {
        throw new AppError_1.AppError('Payload invalide.', 400);
    }
    ...
    const updatedVote = await (0, vote_service_1.handleMaviansWebhook)(paymentReference, status);
 ...
 */
exports.getVoteStatus = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const { paymentReference } = req.params;
    const vote = await (0, vote_service_1.checkAndUpdateVoteStatus)(paymentReference);
