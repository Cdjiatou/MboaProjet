...
// On importe les types Express pour garantir la signature correcte
// des fonctions encapsulées (req, res, next). Cela permet à TypeScript
// de vérifier que les contrôleurs utilisent bien les bons objets.
